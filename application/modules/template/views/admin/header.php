      ...
      <div class="page-header-inner ">
        ...
        <div class="page-logo text-center">
          <a href="<?=base_url('admin/dashboard')?>">
            <img alt="" src="<?=base_url()?>assets/admin/img/profile-removebg-preview.png" width="30" height="30">
          ...
          <ul class="nav navbar-nav pull-right">
                ...
                <li>
                  <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url()?>assets/admin/img/user/user2.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url()?>assets/admin/img/user/user3.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url()?>assets/admin/img/user/user1.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url()?>assets/admin/img/user/user8.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
                    ...
                    <li>
                      <a href="#">
                        <span class="photo">
                          <img src="<?=base_url()?>assets/admin/img/user/user5.jpg" class="img-circle" alt="">
                        </span>
                        <span class="subject">
            ...
            <li class="dropdown dropdown-user">
              ...
              <ul class="dropdown-menu dropdown-menu-default animated jello">
                ...
                <li>
                  <a href="<?=base_url('admin/web-settings')?>">
