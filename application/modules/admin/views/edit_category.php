					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<form action="<?= base_url('admin/category-updated') ?>" enctype="multipart/form-data" method="POST">
								<div class="card-body row">
									<div class="col-lg-6 p-t-20 offset-lg-3">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtRoomNo" name="category_title" value="<?=$edit_category->category_title?>">
