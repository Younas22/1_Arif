<div class="blog-header mt-5">
    <div class="container">
        <div class=""><i class="fa fa-home text-info"></i>
            <a href="#" class="text-secondary text-decoration-none">home</a><a href="#" class="text-secondary text-decoration-none">/<?=$this->uri->segment(1)?></a>
        </div>
        <h1 class="blog-title mt-2"><?= ucfirst($this->uri->segment(1)) ?></h1>
    </div>
</div>
<div class="container">
    <div class="row">
